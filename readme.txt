NEAF (North East Airfield) Maze (Chernarus) For Console and PC json Mod Instructions & Terms Of Use

Spawns a Maze  & related structures at  12109.06 / 12579.03 which is near the Krasno Runway on Chernarus.
...
If you'd like to edit the file, simply load "maze.dze" into DayZ Editor.
...
Upload "maze.json" from the extracted files to inside the "custom" folder of the mission directory on your server.
...
Edit it to look like this: 
	...
	"objectSpawnersArr": ["custom/maze.json"]	
	
If you already are calling custom jsons to spawn items or buildings, seperate the files like this:

	"objectSpawnersArr": ["custom/maze.json","custom/anotherfile.json","custom/differentfile.json"]
